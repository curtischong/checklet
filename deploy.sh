...
cp sockets/dist/bundle.mjs .next/standalone/websocket_server.mjs
...
tmux send-keys -t $session_name:socket-server 'cd /home/ubuntu/standalone && node websocket_server.mjs' C-m
EOF
