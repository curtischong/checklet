    ...
    return (
        <button
            className={classNames(
                `text-gray-600 border border-gray-400 py-2 px-4 rounded transition duration-300 ${className}`,
                {
...
export const LoadingButton: React.FC<IButton & { loading: boolean }> = ({
    ...
    return (
        <>
            <Button
                className={classNames(
                    ` text-gray-600 border border-gray-400 px-4 rounded transition duration-300`,
                    className,
                    {
                        " focus:bg-[#999999] hover:bg-[#5384d4] hover:text-white":
                            !isDisabled,
                        " bg-[#dddddd] focus:bg-[#999999] cursor-not-allowed":
                            isDisabled,
                    },
...
> = ({ className = "", children, url }) => {
    return (
        <a
            ...
            className={classNames(
                "py-1 pl-5 pr-7 inline-block rounded-md hover:text-white hover:bg-[#639fff] hover:border-[#639fff] relative text-primary border-[1px] border-gray-400 leading-[130%] tracking-normal transition duration-300",
                className,
            )}
            style={{
