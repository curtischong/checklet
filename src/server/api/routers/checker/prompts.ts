...
export const inferenceInstructions1dot6 = (prompt: string, doc: string) => {
  return `1) Given the prompt, extract all of the tips/tricks/heuristics into a numbered list.
...
3) Repeat the entire fixed text, and for each edit, explicitly surround your edit with <tip:#> tag:
